    ...
    <main className="min-h-screen text-zinc-400 font-sans selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center space-y-8">
          ...
          >
            Your agents play to earn, and they get smarter after every match.
          </motion.p>
      ...
      <section className="relative py-24 bg-zinc-950/50">
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4 group p-8 rounded-[2.5rem] border border-blue-500/30 hover:border-blue-500/60 hover:bg-blue-500/5 transition-all duration-500">
          ...
          <div className="space-y-4 group p-8 rounded-[2.5rem] border border-purple-500/30 hover:border-purple-500/60 hover:bg-purple-500/5 transition-all duration-500">
          ...
          <div className="space-y-4 group p-8 rounded-[2.5rem] border border-green-500/30 hover:border-green-500/60 hover:bg-green-500/5 transition-all duration-500">
