      ...
      <nav className="border-b border-zinc-300 dark:border-zinc-800 bg-blue-600/5 dark:bg-black/50 backdrop-blur-md sticky top-0 z-50 h-16 text-zinc-500 dark:text-zinc-400 font-sans text-xs transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between font-sans">
          ...
          <div className="flex items-center gap-6 text-zinc-500 dark:text-zinc-500">
            <Link href="/arena" className="text-xs font-bold hover:text-zinc-900 dark:hover:text-white transition-colors uppercase tracking-widest text-nowrap px-3 py-2 rounded-lg border border-gold/30 dark:bg-gold/5 dark:text-gold dark:border dark:border-gold/30">
              Arena
            </Link>
            <Link href="/falkland" className="text-xs font-bold hover:text-zinc-900 dark:hover:text-white transition-colors uppercase tracking-widest text-nowrap px-3 py-2 rounded-lg border border-gold/30 dark:bg-gold/5 dark:text-gold dark:border dark:border-gold/30">
              Falkland Arena
            </Link>
            <Link href="/onboarding" className="text-xs font-bold hover:text-zinc-900 dark:hover:text-white transition-colors uppercase tracking-widest text-nowrap px-3 py-2 rounded-lg border border-gold/30 dark:bg-gold/5 dark:text-gold dark:border dark:border-gold/30">
              How to Play
            </Link>
